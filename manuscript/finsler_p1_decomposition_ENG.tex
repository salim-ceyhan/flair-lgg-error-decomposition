...
the candidate ceiling. Boundary-analysis CIs use patient-clustered resampling
(20,000 replicates; fixed seed 20260724). For the adjusted analysis, the boundary
descriptor, candidate ceiling, log-transformed tumour area, compactness and
...
resamples. The candidate-saturation CIs use paired case resampling with fixed seed
20260726. Other primary case-level bootstrap and sign-flip analyses use fixed seed
20260715. The UCSF grade comparison is exploratory and uses a two-sided
Mann--Whitney $U$ test, Cliff's $\delta$~\cite{cliff1993}, and an independent
20,000-resample bootstrap CI for the grade-3 minus grade-2 mean difference; no
multiplicity adjustment is applied to this single exploratory comparison.
