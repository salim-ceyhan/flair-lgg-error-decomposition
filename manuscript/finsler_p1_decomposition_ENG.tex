...
\hypersetup{
  pdftitle={Error Decomposition in Training-Free Single-FLAIR Lower-Grade Glioma Segmentation: Generation versus Label-Free Selection},
...
near-ceiling/successful class. The top row shows FLAIR with the reference
boundary; the bottom row adds the label-free selected boundary. Yellow denotes
the reference and cyan the selected contour.}
