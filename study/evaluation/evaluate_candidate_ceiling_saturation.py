...
from finsler_tcga_lgg_candidate_selection_study.evaluation.evaluate_fuzzy_membership_augmented_pool import (
    ALPHAS as CURRENT_ALPHAS,
    components,
    dice,
    membership_maps,
)
from finsler_tcga_lgg_candidate_selection_study.evaluation.evaluate_tcga_seed15_alpha_integration import (
    BASE,
    DATA,
    frozen_seeds,
    load_base,
...
OUT = HERE / "results" / "pure_flair_p1_primary_workstation_verified" / "candidate_ceiling_saturation"
CASE_DIR = OUT / "cases"
