...
\begin{itemize}[leftmargin=1.5em,itemsep=0.35em,topsep=0.25em]
  ...
  \item Candidate generation reached a $0.906$ ceiling; label-free Dice remained $0.789$.
  \item Dice$\geq0.70$ candidates existed in $103/110$ cases; $16$ retained a selection gap.
...
decomposition.} Rows show localization failure (L), boundary-representation
...
performance ($0.6473$) and oracle capacity ($0.8010$). Their union increased the
oracle ceiling to $0.8997$, eliminated cases with zero oracle overlap, and raised
Dice-$\ge0.70$ candidate coverage from $103/110$ to $107/110$; nevertheless, the
label-free delivered Dice remained $0.7893$. The additional candidates therefore
expanded boundary availability without producing a measurable gain under the
existing selector.
...
confirmatory evidence of optimality.
...
Finally, the error decomposition and boundary analyses are retrospective. The
...
repository at
\begin{center}\url{https://github.com/salim-ceyhan/flair-lgg-error-decomposition/tree/manuscript-release}\end{center}
