...
\begin{itemize}[leftmargin=1.5em,itemsep=0.35em,topsep=0.25em]
  \item Error decomposition separates localization, representation, and selection.
  \item Expanded candidates raise oracle Dice from $0.872$ to $0.906$.
  \item The canonical pool covers $103/110$ cases at Dice$\geq0.70$.
  \item Weak boundaries predict lower candidate ceilings across three cohorts.
  \item Frozen single-FLAIR segmentation achieves $0.712$ Dice on UCSF-PDGM.
\end{itemize}
\end{tcolorbox}
