...
if __name__ == "__main__":
    ...
    _DATA_ROOT = os.environ.get("FINSLER_DATA_ROOT")
    if not _DATA_ROOT:
        raise SystemExit(
            "Set FINSLER_DATA_ROOT to the directory holding tcga_lgg_dataset/ "
            "before running this demo. See README.md (Data)."
        )
    dp = os.path.join(_DATA_ROOT, "tcga_lgg_dataset", "TCGA_DU_6407_19860514_27")
