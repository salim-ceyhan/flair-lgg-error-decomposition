...
from finsler_tcga_lgg_candidate_selection_study.evaluation.evaluate_fuzzy_membership_augmented_pool import membership_maps,components,dice,ALPHAS
HERE=Path(__file__).resolve().parents[1];DATA=Path(P.DATA_TCGA);BASE=HERE/"results"/"pure_flair_p1_primary_workstation_verified"/"candidate_pool"
