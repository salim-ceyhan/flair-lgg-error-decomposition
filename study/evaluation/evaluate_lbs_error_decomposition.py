...
H=Path(__file__).parents[1];DATA=ROOT/"data"/"tcga_lgg_dataset";POOL=H/"results"/"pure_flair_p1_primary_workstation_verified"/"candidate_pool"
OUT=H/"results"/"pure_flair_p1_primary_workstation_verified"/"lbs_error_decomposition";FIG=H/"results"/"pure_flair_p1_primary_workstation_verified"/"figures"/"lbs_error_decomposition";LT,BT,ST=.5,.7,.1;SEED=20260722
