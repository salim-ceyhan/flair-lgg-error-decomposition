...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Destination directory; historical candidate pools are preserved.",
    )
...
def main() -> None:
    ...
    output_dir.mkdir(parents=True, exist_ok=True); case_dir.mkdir(parents=True, exist_ok=True)
    ...
    print(f"Saved frozen candidate pool to {output_dir}")
